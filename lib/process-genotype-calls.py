...
parser.add_argument('-i', '--input',
	...
	default=False,
	required=True,
	help='Relative or absolute path to the input file (merged.012). This will be internally resolved to an absolute path. This file is generated by 07_vcf-concatn.sh')
parser.add_argument('-c', '--contigLengths',
	dest='contigLengthFile',
	action='store',
	default=False,
	required=True,
	help='The file path to a tab separated file containing contig IDs in the first column and lengths in the next column. This file is generated by 00_contig_stats.sh')
